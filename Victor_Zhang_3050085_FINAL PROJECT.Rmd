...
checkresiduals(T10Y_2Y_ts_decomp$trend)
checkresiduals(diff(T10Y_2Y_ts_decomp$trend))

Box.test(diff(T10Y_2Y_ts_decomp$trend), lag = 1, type = c("Box-Pierce"), fitdf = 0)
Box.test(diff(T10Y_2Y_ts_decomp$trend), lag = 1, type = c("Ljung-Box"), fitdf = 0)

T10Y_2Y_ts_fit2 <- auto.arima(diff(T10Y_2Y_ts_decomp$trend), max.order = 12)
...
autoplot(Flex_CPI_ts)

Flex_CPI_ts_diff <- diff(Flex_CPI_ts)

autoplot(Flex_CPI_ts_diff)
...
checkresiduals(Flex_CPI_ts_decomp$random)
checkresiduals(diff(Flex_CPI_ts_decomp$random))

Box.test(diff(Flex_CPI_ts_decomp$random), lag = 1, type = c("Box-Pierce"), fitdf = 0)
Box.test(diff(Flex_CPI_ts_decomp$random), lag = 1, type = c("Ljung-Box"), fitdf = 0)

Flex_CPI_ts_fit2 <- auto.arima(diff(Flex_CPI_ts_decomp$random), max.order = 12)
...
autoplot(Unemployment_Rate_ts)

Unemployment_Rate_ts_diff <- diff(Unemployment_Rate_ts)

autoplot(Unemployment_Rate_ts_diff)
...
autoplot(Unemployment_Rate_ts_diff2)
...
checkresiduals(Unemployment_Rate_ts_decomp$trend)
checkresiduals(diff(Unemployment_Rate_ts_decomp$trend))

Box.test(diff(Unemployment_Rate_ts_decomp$trend), lag = 1, type = c("Box-Pierce"), fitdf = 0)
Box.test(diff(Unemployment_Rate_ts_decomp$trend), lag = 1, type = c("Ljung-Box"), fitdf = 0)

Unemployment_Rate_ts_fit2 <- auto.arima(diff(Unemployment_Rate_ts_decomp$trend), max.order = 12)
...
autoplot(Federal_Effective_Rate_ts)

Federal_Effective_Rate_ts_diff <- diff(Federal_Effective_Rate_ts)

autoplot(Federal_Effective_Rate_ts_diff)

Box.test(Federal_Effective_Rate_ts_diff, lag = 1, type = c("Box-Pierce"), fitdf = 0)
Box.test(Federal_Effective_Rate_ts_diff, lag = 1, type = c("Ljung-Box"), fitdf = 0)
...
autoplot(Federal_Effective_Rate_ts_diff2)
...
checkresiduals(diff(Federal_Effective_Rate_ts_decomp$trend))

Box.test(diff(Federal_Effective_Rate_ts_decomp$trend), lag = 1, type = c("Box-Pierce"), fitdf = 0)
Box.test(diff(Federal_Effective_Rate_ts_decomp$trend), lag = 1, type = c("Ljung-Box"), fitdf = 0)

Federal_Effective_Rate_ts_fit2 <- auto.arima(diff(Federal_Effective_Rate_ts_decomp$trend), max.order = 12)
